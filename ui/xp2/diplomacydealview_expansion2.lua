print("Loading DiplomacyDealView_Expansion2.lua from Better Deal View (CUI) version 1.0");
--[[
...
print("Loaded DiplomacyDealView_Expansion2.lua from Better Deal View (CUI)");